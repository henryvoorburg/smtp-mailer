        ...
        return [
            ...
            [
                ...
                [
                    false,
                    [
                        'payload' => ['The required properties (MAILER_SSL, MAILER_AUTH, MAILER_QUEUE, SMTP_HOST, SMTP_USER, SMTP_PASSWORD, MAIL_CHARSET, EMAIL_TEMPLATE) are missing']
                    ]
                ] // expected
            ],
            // case 2
            [
                ...
                [
                    ...
                    [
                        ...
                        'MAILER_SSL' => ['The data (string) must match the type: boolean'],
                        'MAILER_THREADS' => ['The data (string) must match the type: integer'],
