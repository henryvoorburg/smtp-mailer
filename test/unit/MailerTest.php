...
final class MailerTest extends TestCase {
    ...
    public function testCanValidateRequestIsInvalid($input, array $expected): void {
        ...
        $this->assertSame(
            $expected,
            Mailer::authenticateRequest($input)
        );
    }
    ...
    public function testCanUpdateQueueMailContent(): void {
        ...
        $this->assertSame(
            self::expectedResponse('success', $expectedData, 'updated queue mail ' . $queueFiles[0]),
            Mailer::authenticateRequest([
    ...
    public function testCanRemoveQueuedMail(): void {
        ...
        $this->assertSame(
            self::expectedResponse('success', null, 'queued mail removed'),
            Mailer::authenticateRequest([
    ...
    public function testCanAddTemplate(): void {
        ...
        $this->assertSame(
            self::expectedResponse('success', null, 'added template test-3.html'),
            Mailer::authenticateRequest([
    ...
    public function testCanUpdateTemplate(): void {
        $this->assertSame(
            self::expectedResponse('success', null, 'updated template test-3.html'),
            Mailer::authenticateRequest([
    ...
    public function testCanRemoveTemplate(): void {
        $this->assertSame(
            self::expectedResponse('success', null, 'template removed'),
            Mailer::authenticateRequest([
